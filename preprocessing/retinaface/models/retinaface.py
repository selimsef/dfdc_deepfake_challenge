...
from preprocessing.retinaface.models.net import MobileNetV1 as MobileNetV1
from preprocessing.retinaface.models.net import FPN as FPN
from preprocessing.retinaface.models.net import SSH as SSH
        ...
        if cfg['name'] == 'mobilenet0.25':
            ...
            if cfg['pretrain']:
                checkpoint = torch.load(
                    "./weights/retinaface/mobilenetV1X0.25_pretrain.tar", map_location=torch.device('cpu'))
                from collections import OrderedDict
